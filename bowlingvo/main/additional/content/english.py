...
def main():
    ...
    GramContent = content_filler.GramContent
    eng_gram = GramContent('Английский', 'english')
    eng_gram.section('Существительное', 'noun')\
        .lesson(1)\
            .theory("<div class='title'> 	Множественное число существительных </div> <div class='theory'> 	<p>Для того, чтобы образовать множественное число существительных, чаще всего, к нему нужно просто прибавить окончание -s</p> 	<p class='example'>book - books (книга - книги)</p> 	<p>Однако, это не всегда так просто, например если слово уже заканчивается на -s или -ss, то к нему нужно добавить не -s, а -es</p> 	<p class='example'>bus - buses (автобус)</p> 	<p class='example'>class - classes (класс)</p> 	<p>То же самое происходит, если существительное оканчивается на -ch, -sh или -x</p> 	<p class='example'>church - churches (церковь)</p> 	<p class='example'>bush - bushes (куст)</p> 	<p class='example'>box - boxes (коробка)</p> 	<p>И если существительное оканчивается на -o</p> 	<p class='example'>hero - heroes (герой)</p> 	<div class='exception'> 		Исключения: 		<p class='example'>piano - pianos (фортепиано)</p> 		<p class='example'>photo - photos (фотография)</p> 	</div> 	<p>Если существительное оканчивается на согласную и букву y, то для образования множественного числа y нужно заменить на i и добавить -es</p> 	<p class='example'>vocabulary - vocabularies (словарь)</p> 	<p>Если же конечная y стоит после гласной, то на i она не заменяется</p> 	<p class='example'>friday - fridays (пятница)</p> 	<p>Если на конце слова стоит -f, она заменяется на v и к слову прибавляется -es</p> 	<p class='example'>leaf - leaves (лист)</p> 	<div class='exception'> 		Исключения: 		<p class='example'>roof - roofs (крыша)</p> 		<p class='example'>chief - chiefs (начальник)</p> 	</div> 	<p>И, наконец, если слово оканчивается на -fe, то -fe заменятся на -ve + s</p> 	<p class='example'>wife - wives (жена)</p> 	<div class='exception'> 		Исключение: <span>safe - safes</span> 	</div> 	<p>Есть так же слова, которые не подчиняются ни одному из этих правил и изменяются по числам совершенно иначе</p> 	<p class='example'>man - men (мужчина)</p> 	<p class='example'>woman - women (женщина)</p> 	<p class='example'>child - children (ребёнок - дети)</p> 	<p class='example'>tooth - teeth (зубы)</p> 	<p class='example'>foot - feet (нога)</p> 	<p class='example'>mouse - mice (мышь)</p> 	<p class='example'>sheep - sheep (овца)</p> 	<p class='example'>ox - oxen (бык, вол)</p> </div>")\
            .task('I', 'Ox - {}', 'oxen')\
            .task('I', 'Wolf - {}', 'wolves')\
            .task('I', 'Sheep - {}', 'sheeps')\
            .task('I', 'Monkey - {}', 'monkeys')\
            .task('I', 'Man - {}', 'men')\
            .task('I', 'Sunday - {}', 'sundays')\
        .end()\
    .end()\

...
def main():
    ...
    s = eng_lex.section('Транспорт', 'transport')
    s.lesson(1)\
    ...
    s = eng_lex.section('Профессии', 'professions')
    s.lesson(1)\
    ...
    s = eng_lex.section('Семья', 'family')
    s.lesson(1)\
    ...
    s = eng_lex.section('Тело человека', 'body')
    s.lesson(1)\
    ...
    s = eng_lex.section('Одежда', 'clothing')
    s.lesson(1)\
